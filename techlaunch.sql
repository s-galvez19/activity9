...
INSERT INTO `countries` (`code`, `country`, `lang`) VALUES
('ABW', 'Aruba', 'en'),
('AFG', 'Afghanistan', 'es'),
('AGO', 'Angola', 'es'),
('AIA', 'Anguilla', 'en'),
...
INSERT INTO `courses` (`id`, `code`, `class`, `description`, `start_date`, `end_date`, `professor`, `start_time`, `cost`, `credit_hours`, `prerequisites`) VALUES
